...
- 自动检查覆盖12项：段落长度、句子长度、标题层级、错别字、标点、中英间距、加粗密度、禁用词、bullet列表、开头质量、结尾格式、词频
- 存在🔴项不得提交终稿
...
| 角色 | 颜色 | HEX | 用途 |
|------|------|-----|------|
| 主色调 | 科技蓝 | #002060 / #0F62AD / #2E75B5 | 标题、图表、背景元素、装饰 |
| 强调色 | 中国红 | #C00000 / #FF0000 | 章节标题、关键词、图表高亮、关键数据 |
| 辅助色 | 亮黄色 | #FFFF00 | 图表辅助色、重点标记（慎用） |
| 辅助色 | 典雅紫 | #7030A0 | 图表辅助色、部分标题（慎用） |
| 正文色 | 深邃黑 | #000000 | 大段正文文本 |
| 正文色 | 高级灰 | #3F3F3F | 副标题、辅助说明 |
| 背景色 | 纯白 | #FFFFFF | 内容页背景 |
...
| 用途 | 字体 | 字重 | 字号(16:9) |
|------|------|------|-----------|
| 封面主标题 | 微软雅黑 | Bold | 36-44pt |
| 副标题/单位 | 微软雅黑 | Regular | 20-28pt |
| 章节/过渡页标题 | 微软雅黑 | Bold | 32-40pt（红色或蓝色） |
| 内容页标题 | 微软雅黑 | Bold | 24-28pt |
| 正文文本 | 微软雅黑 | Regular | 16-20pt |
| 图表/数据标签 | 微软雅黑/Arial | Regular | 12-16pt |
| 英文/数字 | Times New Roman/Arial | Regular | 12-18pt |
...
| 中文 | 2500-4000字 | 6-8节 | 400-600字 | 5-8分钟 |
...
| PAT | 不适用 | 背景技术不刻意自引 |
| BK | 3-15% | 按章节性质灵活控制 |
| STD-CN | 不适用 | 引用已颁布国标/行标 |
| STD-INT | 不适用 | 引用已颁布ISO/IEC标准 |
| PPT | 不适用 | 演示文稿不涉及引用管理 |
