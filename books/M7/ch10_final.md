...
**10-1.** 为什么交付度量必须同时包含结果、过程与风险三类指标？  
**10-2.** 解释 $J_{delivery}$ 中 $\gamma$ 不宜过低的工程原因。  
**10-3.** 列出最终发布门禁总表中的三项必选条件。

### 应用题

**10-4.** 为某流域调度中心设计季度交付看板，至少包含 8 个指标与预警阈值。  
**10-5.** 基于 ch01-ch09 产物，给出一份可执行的跨章节验收清单模板。

### 思考题

**10-6.** 在“提升发布效率”与“强化安全门禁”存在冲突时，组织层面应如何制定决策原则？

### 基础题参考答案要点

**10-7.** 仅看结果会忽略过程质量与风险积累，难以支撑长期稳定。  
**10-8.** 因安全是水系统硬约束，权重过低会导致错误激励。  
**10-9.** 如关键路径测试100%、回滚预案演练达标、审计链路可追溯等。
