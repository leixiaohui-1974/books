...
> **文体特殊步骤**：
> - **WX**: 步骤6后、步骤7前必须运行 `scripts/check_article.py`，🔴项清零后方可评审。
> - **PPT**: 步骤6使用 pptxgenjs 生成 .pptx，步骤7前须 LibreOffice 转PDF视觉QA。
> - **STD-CN/STD-INT**: 步骤6后须对全文条文用语进行一致性校验（应/宜/可 或 shall/should/may）。
