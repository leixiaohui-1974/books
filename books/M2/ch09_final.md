...
**9-1.** 为什么安全约束必须在优化器中显式表达？
**9-2.** 绿色/黄色/红色区的控制策略差异是什么？
**9-3.** ODD 与最小风险状态之间有什么关系？

### 应用题

**9-4.** 设计一个含红黄绿区间与联锁触发条件的 MPC 约束体系。  
**9-5.** 设计安全事件审计报表字段，并说明哪些字段用于责任追溯。

### 思考题

**9-6.** 若经济优化目标与安全缓冲策略冲突，你会如何设定优先级与审批流程？

### 基础题参考答案要点

**9-7.** 因否则优化可能输出物理可算但工程不安全的解。  
**9-8.** 绿色区常态优化，黄色区预警收紧，红色区联锁降级。  
**9-9.** ODD定义允许运行边界，越界时进入最小风险状态。
