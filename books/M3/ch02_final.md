...
4. 设计一个含3个约束的判定流程并给出伪代码。
5. 构建L1/L2/L3告警阈值建议表并说明依据。

### 思考题

6. 在通信延迟显著波动时，在线判定流程应如何避免误告警与漏告警？
