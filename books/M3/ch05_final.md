...
**5-1.** 在线校核与离线评估在目标与时效上有何差异？
**5-2.** 为什么回归门禁需要分层，而不是单一综合分数？
**5-3.** 说明回滚触发条件中 $N_{vio}$ 与 $T_{amber}$ 的互补意义。

### 应用题

**5-4.** 设计一个包含5类工况的在环用例矩阵，并给出通过标准。
**5-5.** 为某次告警风暴恢复窗口制定执行清单与升级路径。

### 思考题

**5-6.** 当运行绩效优异但安全门禁轻微失败时，是否允许“附条件放行”？请给出你的治理原则。
