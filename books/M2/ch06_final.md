...
1. 为什么约束收紧是鲁棒MPC中常用且有效的手段？
2. Tube MPC 与情景MPC在工程侧重点上有何差异？
3. 鲁棒性与保守性为何不能简单画等号？

### 应用题

4. 设计一个含不确定集的鲁棒MPC约束体系，并说明收紧系数整定步骤。  
5. 针对“超时+违约双异常”场景，设计分级降级与恢复逻辑。

### 思考题

6. 若管理层要求“零违约”，你将如何解释其对能耗、供水效率与控制动作的影响？

### 基础题参考答案要点

1. 因其可将扰动影响前置到可行域设计中，降低在线违约风险。  
2. Tube MPC重在有界误差保证，情景MPC重在概率意义下性能-风险折中。  
3. 过度保守会显著损失效率与经济性，需分工况平衡。
