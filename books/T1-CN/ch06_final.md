...
![fig_06_01](https://raw.githubusercontent.com/leixiaohui-1974/books/main/books/T1-CN/H/fig_06_01_controllability_criteria.png)
...
![fig_06_02](https://raw.githubusercontent.com/leixiaohui-1974/books/main/books/T1-CN/H/fig_06_02_wnal_requirements.png)

> 图6-2：WNAL等级与可控可观性要求对应关系。等级越高，对系统可控可观性的要求越严格。

![fig_06_03](https://raw.githubusercontent.com/leixiaohui-1974/books/main/books/T1-CN/H/fig_06_03_controllability_observability.png)
...
![fig_06_04](https://raw.githubusercontent.com/leixiaohui-1974/books/main/books/T1-CN/H/fig_06_04_state_estimator.png)
...
**3. 混合整数规划**
- 将问题建模为混合整数线性规划（MILP）[6-8]
- 使用商业求解器（如 Gurobi、CPLEX）求解
- 优点：可得到全局最优解
- 缺点：大规模问题求解时间长

![fig_06_05](https://raw.githubusercontent.com/leixiaohui-1974/books/main/books/T1-CN/H/fig_06_05_optimization_algorithm.png)

> 图6-5：传感器布局优化贪婪算法流程。每次迭代选择可观性指标提升最大的候选位置，直到满足预算约束。

**4. 信息论方法**
- 基于互信息、信息熵等指标评估传感器信息增益 [6-9]
- 选择使信息增益最大的传感器组合
- 优点：理论基础严密，可量化传感器冗余度
- 缺点：需要准确的概率模型
...
三级验证的核心价值不在于"证明控制器能工作"，而在于"系统地发现控制器在何种条件下会失效"。通过构建覆盖正常、异常和极端工况的场景库，在虚拟环境中暴露问题，远比在真实工程中"试错"安全和经济。雷晓辉团队 在胶东调水工程和南水北调中线工程中建立了完整的三级在环测试体系，为 WNAL 等级评估提供了可操作的验证方法。
...
>
> **验证流程**：
> 1. **MIL 验证**（2 周）：在 Simulink 中搭建 IDZ 模型，验证 MPC 控制逻辑 [6-7]
...
![fig_06_06](https://raw.githubusercontent.com/leixiaohui-1974/books/main/books/T1-CN/H/fig_06_06_gramian_eigenvalues.png)
...
![fig_06_07](https://raw.githubusercontent.com/leixiaohui-1974/books/main/books/T1-CN/H/fig_06_07_sensor_optimization.png)
...
**第二条主线：传感器布局优化**。通过可观性格拉姆矩阵最大化框架，可以定量回答"哪里需要传感器、需要多少个"。§7.3.2 介绍了贪婪算法、遗传算法、混合整数规划三种求解方法，适用于不同规模的工程问题。§7.6–6.7 的两个工程实例表明：与均匀布设相比，优化布局在削减 40%–65% 传感器数量的同时，可将状态估计 RMSE 提升 40%–70%，年运维费用节省 20%–50%。优化的核心逻辑是"以信息价值密度而非空间密度为导向"。
...
[6-5] Luenberger D G. An introduction to observers[J]. IEEE Transactions on Automatic Control, 1971, 16(6): 596-602.

[6-6] Litrico X, Fromion V. Modeling and control of hydrosystems[M]. London: Springer, 2009.

[6-7] Van Overloop P J. Model predictive control on open water systems[D]. Delft: TU Delft, 2006.

[6-8] Sela L, Amin S. Robust sensor placement for pipeline monitoring: Mixed integer and greedy optimization[J]. Advanced Engineering Informatics, 2018, 36: 55-63.

[6-9] Santos-Ruiz I, López-Estrada F R, Valencia-Palomo G, et al. Pressure sensor placement for leak localization in water distribution networks using information theory[J]. Sensors, 2022, 22(2): 443.
