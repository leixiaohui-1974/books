<!-- 变更日志
v2 2026-02-16: 根据四角色评审修订——补充术语一致性声明与基础题答案要点，强化教学可用性
v1 2026-02-16: 初稿
-->
...
**4-1.** 说明为何 ROM 不等于“随意简化模型”。  
**4-2.** 写出 IDZ 模型表达，并解释 \(K\) 与 \(\tau\) 的工程意义。  
**4-3.** Muskingum-Cunge 系数满足什么约束？其意义是什么？



### 基础题参考答案要点

**4-4.** ROM 是“保留关键动态与关键约束后的结构化简化”，不是去掉难点。  
**4-5.** IDZ: \(G(s)=K\frac{1+T_z s}{s}e^{-\tau s}\)，\(K\) 体现稳态增益，\(\tau\) 体现纯延时。  
**4-6.** Muskingum-Cunge 系数满足 \(C_0+C_1+C_2=1\)，用于保证质量平衡一致性。

### 应用题

**4-7.** 给定两组 IDZ 参数，比较其在“响应速度—稳态偏差—时滞补偿”上的差异，并给出上线建议。  
**4-8.** 为某渠段设计一个最小可执行的频率域辨识试验方案（输入设计、采样频率、校核指标）。

### 思考题

**4-9.** 当数据驱动 ROM 拟合精度高于机理 ROM，但可解释性较差时，你会如何制定双轨上线策略？
