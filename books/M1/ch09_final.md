...
**9-1.** 为什么 ROM 比较必须同时考虑精度、实时性、稳健性、运维性？  
**9-2.** 统计显著性与工程显著性有什么差异？  
**9-3.** 硬约束筛选应先于加权评分的原因是什么？

### 基础题参考答案要点

**9-4.** 因为上线决策是多目标约束问题，单指标最优可能在其他维度不可用。  
**9-5.** 统计显著性关注“差异是否可靠”，工程显著性关注“差异是否足以改变运行决策”。  
**9-6.** 可先剔除不可上线候选，避免加权评分掩盖安全或实时性硬缺陷。

### 应用题

**9-7.** 给定三模型评分与权重，完成综合分计算并给出上线建议。  
**9-8.** 设计一个面向冰期的模型对比测试集，需包含至少4类场景与对应指标。

### 思考题

**9-9.** 若团队在“高精度低可解释”与“中精度高可维护”之间分歧较大，你将如何组织决策流程？
