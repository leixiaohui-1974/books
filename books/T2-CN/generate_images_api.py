...
.env 配置:
  ...
  NB_MODEL     = nb2 | nb-pro | nb | gemini-3.1-flash-image-preview | ...
  NB_STYLE     = 自定义风格前缀（可选）
  NB_RETRIES   = 3
  NB_TIMEOUT   = 180
  NB_POLL_MAX  = 300
...
# ─── 模型别名表（简短别名 → Google 官方 model ID）───
MODEL_ALIASES = {
    # Nano Banana 2 (2026-02-26, Flash架构, Pro品质, 最新推荐)
    "nb2":              "gemini-3.1-flash-image-preview",
    "nano-banana-2":    "gemini-3.1-flash-image-preview",
    # Nano Banana Pro (2025-11, Pro架构)
    "nb-pro":           "gemini-3-pro-image-preview",
    "nano-banana-pro":  "gemini-3-pro-image-preview",
    # Nano Banana 原版 (2025-08, Flash架构)
...
class Config:
    ...
    def init(cls, args=None):
        ...
        cls.MODEL = _resolve_model(_get("model", "NB_MODEL", "nb2"))
