...
**12-1.** 为什么大规模水网不宜采用单一集中式控制？  
**12-2.** L0/L1/L2 三层在时间尺度和职责上有何差异？  
**12-3.** 跨层信息流中的“约束回传”有什么作用？

### 基础题参考答案要点

**12-4.** 因大规模系统存在通信、算力与组织边界约束，集中式方案易出现实时性与鲁棒性不足。  
**12-5.** L0负责秒级执行与联锁，L1负责分钟级局部优化，L2负责小时级全局协调与资源分配。  
**12-6.** 约束回传用于将局部可行域和风险信息反馈给上层，保证全局调度可执行且不越界。

### 应用题

**12-7.** 为“2泵站+3渠段”系统设计一个简化的L2-L1协调流程。  
**12-8.** 设计一次通信中断场景下的HDC降级测试方案。

### 思考题

**12-9.** 当局部最优与全局最优冲突时，HDC应如何设定优先级机制？
